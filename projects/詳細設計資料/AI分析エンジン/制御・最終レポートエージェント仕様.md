...
> 現状（2025-08-20）: 本仕様に対応する実装は未着手です。まずは `drowsy_detection`・`core_lib`・`DataWareHouse` の動作整合と評価ツール整備を優先し、その後に段階的に実装します。
...
Response JSON:
{
  ...
  "artifacts": {
    "notebook": "reports/analysis_report_YYYYMMDD_HHMMSS.ipynb",
    "html": "reports/analysis_report_YYYYMMDD_HHMMSS.html",
